...
class _ShapePageState extends State<ShapePage>
  ...
  void initState() {
    ...
    scene.set([
      RectElement(
          rect: Rect.fromPoints(const Offset(0, 0), const Offset(500, 500)),
          style: style)
    ], CircleElement(center: const Offset(150, 150), radius: 70));
  ...
  void _update() {
    ...
    scene.set(
        ...
        RectElement(
            rect: Rect.fromPoints(const Offset(0, 0), const Offset(100, 100)),
